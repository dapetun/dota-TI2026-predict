...
DEPRECATED legacy path (LightGBM + multi-model CV). Prefer
``src.models.xgboost_model`` / ``catboost_model`` / ``ensemble`` via
``scripts/train_compare.py``. LightGBM is optional and only used here.
"""
