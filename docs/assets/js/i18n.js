...
const STRINGS = {
  ru: {
    ...
    "meta.description": "Прогноз групповой стадии The International 2026",
    "brand.kicker": "The International 2026",
    ...
    "hero.title": "Прогнозы",
    "hero.lead": "16 команд · Swiss до 4 побед или поражений",
    "disclaimer.label": "Важно",
    "disclaimer.summary": "Не для ставок · кратко о прогнозе",
    "disclaimer.loading": "Загрузка…",
    "disclaimer.body":
      "Прогноз Swiss-доски и слотов компендиума TI 2026. Основан на матчевых данных, мнениях аналитиков и рыночных вероятностях. Неопределённость высокая — не для ставок и не финансовый совет.",
    "warn.market_prior_power_rankings":
      "Рыночные вероятности временно недоступны; в прогнозе учтены модель и аналитики.",
    ...
    "strategy.fusion": "Рекомендуемый",
    "strategy.fusion_hint": "Баланс модели и аналитиков по умолчанию",
    ...
    "strategy.fusion_custom": "Собственные настройки",
    "strategy.fusion_custom_hint": "Задайте веса модели, аналитиков, рынка и рейтинга сами",
    "fusion.custom_help": "Передвигайте ползунки — доска пересчитается сразу. Веса независимы и не обязаны давать 100%.",
    "fusion.custom_unavailable": "Свои настройки недоступны для этих данных.",
    "fusion.weights_label": "Вариант прогноза",
    "fusion.weights_help":
      "Выберите готовый вариант или откройте собственные настройки и задайте веса источников.",
    ...
    "fusion.weight.market": "Рынок",
    "fusion.weight.ranking": "Силовой рейтинг",
    "fusion.weight.expert": "История экспертов",
    "fusion.weight_in_mix": "доля",
    "fusion.weights_raw_sum":
      "Сумма выбранных весов: {sum} (не обязана быть 100). У каждого источника — итоговая доля.",
    "fusion.score": "Ожидаемые очки",
    "fusion.correct_slots": "верных слотов ≈",
    "fusion.market_fallback":
      "Рыночные вероятности временно недоступны.",
    "fusion.market_derived":
      "Рынок: вероятности победителя турнира пересчитаны в шансы Swiss-слотов. Не линии букмекеров на 4-0/вылет.",
    "fusion.market_direct":
      "Рынок: прямые котировки на Swiss-слоты.",
    ...
    "matchup.lead": "Парная вероятность победы между командами.",
    "matchup.team_a": "Команда A",
    "matchup.team_b": "Команда B",
    "matchup.series_win": "вероятность победы серии",
    "model.title": "Состояние модели",
    "model.lead_fallback": "Модель по матчам и силе команд (μ±σ).",
    "model.methodology":
      "Мы берём результаты матчей турниров и оцениваем силу каждой команды. У 100% матчей корпуса (8709/8709) есть составы игроков. Модель сравнивает две команды и говорит, кто вероятнее победит. Затем много раз проигрываем весь Swiss-турнир и смотрим, куда чаще попадает каждая команда. Качество проверяем на прошлых TI и на свежих матчах. Итоговый прогноз объединяет модель, мнения аналитиков и рыночные вероятности. Число μ ± σ на сайте — сила команды ± насколько мы в ней уверены. Технические подробности — в разделе «Как считаем» ниже.",
    ...
    "how.card5.body":
      "Качество проверяем на прошлых The International и на свежих матчах. AUC около 0.5 — как монетка; у текущей модели около 0.61 на недавних TI.",
    "how.card6.title": "6. Числа в интерфейсе",
    "how.card6.body":
      "μ ± σ — сила команды и насколько мы в ней уверены. Карта слотов — шансы попасть в каждый слот. Можно выбрать готовый вариант прогноза или свои веса.",
    ...
    "how.details_li3":
      "Полураспад выборки 180д; форма ~40д; патч ≥7.41 ×1.4.",
    "how.details_li4":
      "Основная модель — CatBoost по парам команд.",
    "how.details_li5":
      "Нечётный остаток в корзине рекорда Swiss получает bye без авто-победы (упрощение симуляции).",
    "footer.open": "Данные — OpenDota.",
    "footer.license": "Лицензия MIT",
    "footer.copyright": "Copyright © 2026 dapetun",
    "footer.visual_attribution":
      "Визуальный фон вдохновлён / использует материалы The International (© Valve Corporation). Фанатский исследовательский сайт, не аффилирован с Valve.",
    ...
    "chip.fusion": "Сводный",
    "chip.analysts_fusion": "Аналитики / сводный",
    "chip.sims": "Прогонов турнира",
    "chip.market_derived": "Рынок учтён",
    "chip.market_direct": "Рынок: Swiss-slot книги",
    "chip.market_seeded": "Рынок: fallback рейтинг",
    "chip.market_live": "Рынок: live",
    "chip.swiss_phase_pre": "Снимок до GS",
    "chip.swiss_phase_live": "GS live",
    "chip.model_blend": "Прогноз модели",
    "chip.model_power": "Упрощённый рейтинг",
    "chip.model_catboost": "Модель",
    ...
    "fallback.banner":
      "Сейчас используется упрощённый рейтинг команд.",
    "valve.points_title": "Очки Valve за точные слоты:",
    "metric.loo": "Проверка на недавних TI",
    "metric.loo_hint": "AUC на TI12–TI14 (hold-out). 0.5 = монетка; ~0.60–0.65 — нормальный уровень для карт на смене меты.",
    "metric.wf": "По времени (walk-forward)",
    "metric.wf_hint": "AUC на свежих окнах корпуса — ближе к текущей силе команд, чем старые TI.",
    ...
    "title.both_pts": "Ожидаемые очки: аналитики и сводный прогноз совпадают",
  ...
  en: {
    ...
    "hero.lead": "16 teams · Swiss to 4 wins or losses",
    "disclaimer.label": "Note",
    "disclaimer.summary": "Not for betting · about this forecast",
    "disclaimer.loading": "Loading…",
    "disclaimer.body":
      "TI 2026 Swiss board and compendium slot forecast. Built from match data, analyst views, and market probabilities. Uncertainty is high — not for betting and not financial advice.",
    "warn.market_prior_power_rankings":
    ...
    "strategy.fusion_custom": "Custom settings",
    "strategy.fusion_custom_hint": "Set model, analysts, market, and ranking weights yourself",
    "fusion.custom_help": "Move the sliders — the board updates immediately. Weights are independent and need not sum to 100%.",
    "fusion.custom_unavailable": "Custom settings are unavailable for this data.",
    "fusion.weights_label": "Source weights",
    "fusion.weights_help":
      "Pick a ready-made variant or open custom settings and set your own source weights.",
    ...
    "fusion.market_derived":
      "Market: tournament-winner odds projected onto Swiss slots (not bookmaker 4-0/elim lines).",
    "fusion.market_direct":
      "Market: direct Swiss-slot books (Polymarket). Research only — not for betting.",
    ...
    "model.lead_fallback": "Match-based team strength model (μ±σ).",
    "model.methodology":
      "We take tournament match results and estimate each team’s strength. 100% of corpus matches (8709/8709) have player rosters. The model compares two teams and estimates who is more likely to win. Then we simulate the full Swiss many times and see where each team lands most often. Quality is checked on past TIs and recent matches. The published forecast combines the model with analyst views and market probabilities. μ ± σ on the site is team strength ± how sure we are. More detail is in “How we compute” below.",
    ...
    "how.card5.body":
      "LOO AUC — past TI test (closer to TI 2026). Walk-forward AUC — stability over time. AUC ~0.5 = coin flip; now LOO ≈0.608 (TI12–14), WF ≈0.653.",
    ...
    "how.details_li3":
      "Sample half-life 180d; form half-life ~40d; patch ≥7.41 ×1.4.",
    "how.details_li4":
      "Production: CatBoost-only (no isotonic). Brier/ECE in model_compare.",
    "how.details_li5":
    ...
    "footer.copyright": "Copyright © 2026 dapetun",
    "footer.visual_attribution":
      "Visual background inspired by / uses The International materials (© Valve Corporation). Fan research site — not affiliated with Valve.",
    "footer.aria": "Footer",
    ...
    "chip.fusion": "Combined",
    "chip.analysts_fusion": "Analysts / mixed",
    "chip.sims": "Tournament sims",
    "chip.market_derived": "Market included",
    "chip.market_direct": "Market: Swiss-slot books",
    "chip.market_seeded": "Market: ranking fallback",
    "chip.market_live": "Market: live",
    "chip.swiss_phase_pre": "Pre-GS snapshot",
    "chip.swiss_phase_live": "GS live",
    "chip.model_blend": "Model forecast",
    "chip.model_power": "Simple ranking",
    "chip.model_catboost": "Model",
    "chip.model_xgb": "XGBoost",
    ...
    "fallback.banner":
      "Using a simplified team ranking for now.",
    "valve.points_title": "Valve points for exact slots:",
    "metric.loo": "Recent TI check",
    "metric.loo_hint": "AUC on TI12–TI14 hold-outs. 0.5 = coin flip; ~0.60–0.65 is normal for map outcomes across meta shifts.",
    "metric.wf": "Walk-forward",
    "metric.wf_hint": "AUC on recent time windows — closer to current team strength than old TIs.",
...
STRINGS.de = cloneEn({
  ...
  "nav.repo": "Repository",
  "nav.home": "Prognose",
  "nav.group.participate": "Mitmachen",
  "nav.group.support": "Mehr erfahren",
  "nav.aria.primary": "Hauptnavigation",
  "nav.aria.secondary": "Sekundärnavigation",
  "lang.label": "Sprache",
  "hero.eyebrow": "The International 2026 · Gruppenphase",
  "hero.title": "Wer kommt aus dem Swiss weiter?",
  "hero.lead": "16 Teams · Swiss bis 4 Siege oder Niederlagen",
  "disclaimer.label": "Wichtig",
  "disclaimer.summary": "Keine Wetten · kurz zum Forecast",
  "disclaimer.loading": "Laden…",
  "disclaimer.body":
    "Dies ist eine Forschungsprognose des TI-2026-Swiss-Bretts und der Compendium-Slots. Gebaut aus Matchdaten: Modell + Analysten + Markt. Hohe Unsicherheit — keine Wetten und keine Finanzberatung. Marktwerte nur als Forschungssignal. Der Autor wirbt nicht für Buchmacher.",
  "standings.power_rank": "Rang",
  "source.direct_invite": "Direkte Einladung",
  "source.eu_qualifier": "EU-Qualifier",
  "source.sea_qualifier": "SEA-Qualifier",
  "source.na_qualifier": "NA-Qualifier",
  "source.sa_qualifier": "SA-Qualifier",
  "source.cn_qualifier": "CN-Qualifier",
  "chip.model_catboost": "CatBoost (paarweise)",
  "chip.model_xgb": "XGBoost",
  "format.swiss_short": "Swiss 16→4",
  "footer.aria": "Fußzeile",
  "footer.copyright": "Copyright © 2026 dapetun",
  "rules.redirect": "Regeln der Gruppenphase →",
  "model.methodology":
    "Wir nehmen Turnier-Matchdaten und schätzen die Stärke jedes Teams. 100 % der Corpus-Matches (8709/8709) haben Spieleraufstellungen. Das Modell vergleicht zwei Teams und schätzt die Siegchance. Dann simulieren wir den gesamten Swiss viele Male. Qualität prüfen wir an vergangenen TIs und aktuellen Matches. Die Veröffentlichung mischt Modell, Analysten und Markt. μ ± σ ist Stärke ± Unsicherheit. Mehr unter „So rechnen wir“.",
  ...
  "standings.lead":
    "<strong>μ ± σ</strong> — Stärke und Unsicherheit. Quali / Elim — Anteil der Swiss-Simulationen (~50.000).",
...
STRINGS.fr = cloneEn({
  ...
  "nav.home": "Pronostic",
  "lang.label": "Langue",
  "nav.group.participate": "Participer",
  "nav.group.support": "En savoir plus",
  "nav.aria.primary": "Navigation principale",
  "nav.aria.secondary": "Navigation secondaire",
  "hero.eyebrow": "The International 2026 · Phase de groupes",
  "hero.title": "Qui sort du Swiss ?",
  "hero.lead": "16 équipes · Swiss jusqu’à 4 victoires ou défaites",
  "disclaimer.label": "Important",
  "disclaimer.summary": "Pas pour parier · à propos du pronostic",
  "disclaimer.loading": "Chargement…",
  "disclaimer.body":
    "Pronostic de recherche du tableau Swiss TI 2026 et des slots du compendium. Construit à partir des matchs : modèle + analystes + marché. Forte incertitude — pas pour parier. Les probabilités de marché sont un signal de recherche. L’auteur ne fait pas la promotion des bookmakers.",
  "standings.power_rank": "rang",
  "source.direct_invite": "Invitation directe",
  "source.eu_qualifier": "Qualif. EU",
  "source.sea_qualifier": "Qualif. SEA",
  "source.na_qualifier": "Qualif. NA",
  "source.sa_qualifier": "Qualif. SA",
  "source.cn_qualifier": "Qualif. CN",
  "chip.model_catboost": "CatBoost (paires)",
  "chip.model_xgb": "XGBoost",
  "format.swiss_short": "Swiss 16→4",
  "footer.aria": "Pied de page",
  "footer.copyright": "Copyright © 2026 dapetun",
  "rules.redirect": "Règles de la phase de groupes →",
  "model.methodology":
    "Nous prenons les résultats des matchs de tournoi et estimons la force de chaque équipe. 100 % des matchs du corpus (8709/8709) ont des compositions. Le modèle compare deux équipes et estime qui gagne. Puis nous simulons tout le Swiss de nombreuses fois. La qualité est vérifiée sur les TI passés et les matchs récents. Le pronostic publié mélange modèle, analystes et marché. μ ± σ = force ± incertitude. Plus de détail dans « Comment on calcule ».",
  ...
  "standings.lead":
    "<strong>μ ± σ</strong> — force et incertitude. Qualifier / Éliminé — part des simulations Swiss (~50 000).",
...
STRINGS.pt = cloneEn({
  ...
  "nav.home": "Previsão",
  "lang.label": "Idioma",
  "nav.group.participate": "Participar",
  "nav.group.support": "Saiba mais",
  "nav.aria.primary": "Navegação principal",
  "nav.aria.secondary": "Navegação secundária",
  "hero.eyebrow": "The International 2026 · Fase de grupos",
  "hero.title": "Quem avança no Swiss?",
  "hero.lead": "16 times · Swiss até 4 vitórias ou derrotas",
  "disclaimer.label": "Importante",
  "disclaimer.summary": "Não é aposta · sobre a previsão",
  "disclaimer.loading": "Carregando…",
  "disclaimer.body":
    "Previsão de pesquisa do painel Swiss do TI 2026 e dos slots do compêndio. Feita com dados de partidas: modelo + analistas + mercado. Alta incerteza — não é aposta. Probabilidades de mercado são só sinal de pesquisa. O autor não promove casas de apostas.",
  "standings.power_rank": "rank",
  "source.direct_invite": "Convite direto",
  "source.eu_qualifier": "Qualif. EU",
  "source.sea_qualifier": "Qualif. SEA",
  "source.na_qualifier": "Qualif. NA",
  "source.sa_qualifier": "Qualif. SA",
  "source.cn_qualifier": "Qualif. CN",
  "chip.model_catboost": "CatBoost (pares)",
  "chip.model_xgb": "XGBoost",
  "format.swiss_short": "Swiss 16→4",
  "footer.aria": "Rodapé",
  "footer.copyright": "Copyright © 2026 dapetun",
  "rules.redirect": "Regras da fase de grupos →",
  "model.methodology":
    "Usamos resultados de partidas de torneios e estimamos a força de cada time. 100% das partidas do corpus (8709/8709) têm elenco. O modelo compara dois times e estima quem vence. Depois simulamos o Swiss inteiro muitas vezes. A qualidade é checada em TIs passados e partidas recentes. A previsão publicada mistura modelo, analistas e mercado. μ ± σ = força ± incerteza. Mais detalhes em «Como calculamos».",
  ...
  "standings.lead":
    "<strong>μ ± σ</strong> — força e incerteza. Classificar / Eliminado — parcela das simulações Swiss (~50.000).",
...
STRINGS.es = cloneEn({
  ...
  "lang.label": "Idioma",
  "nav.group.participate": "Participar",
  "nav.group.support": "Más información",
  "nav.aria.primary": "Navegación principal",
  "nav.aria.secondary": "Navegación secundaria",
  "hero.eyebrow": "The International 2026 · Fase de grupos",
  "hero.title": "¿Quién avanza del Swiss?",
  "hero.lead": "16 equipos · Swiss hasta 4 victorias o derrotas",
  "disclaimer.label": "Importante",
  "disclaimer.summary": "No es para apostar · sobre el pronóstico",
  "disclaimer.loading": "Cargando…",
  "disclaimer.body":
    "Pronóstico de investigación del tablero Swiss de TI 2026 y de los slots del compendio. Hecho con datos de partidas: modelo + analistas + mercado. Alta incertidumbre — no es para apostar. Las probabilidades de mercado son solo señal de investigación. El autor no promociona casas de apuestas.",
  "standings.power_rank": "rango",
  "source.direct_invite": "Invitación directa",
  "source.eu_qualifier": "Qualy EU",
  "source.sea_qualifier": "Qualy SEA",
  "source.na_qualifier": "Qualy NA",
  "source.sa_qualifier": "Qualy SA",
  "source.cn_qualifier": "Qualy CN",
  "chip.model_catboost": "CatBoost (pares)",
  "chip.model_xgb": "XGBoost",
  "format.swiss_short": "Swiss 16→4",
  "footer.aria": "Pie de página",
  "footer.copyright": "Copyright © 2026 dapetun",
  "rules.redirect": "Reglas de la fase de grupos →",
  "model.methodology":
    "Tomamos resultados de partidas de torneos y estimamos la fuerza de cada equipo. El 100% de las partidas del corpus (8709/8709) tienen plantilla. El modelo compara dos equipos y estima quién gana. Luego simulamos todo el Swiss muchas veces. La calidad se comprueba en TIs pasados y partidas recientes. El pronóstico publicado mezcla modelo, analistas y mercado. μ ± σ = fuerza ± incertidumbre. Más detalle en «Cómo calculamos».",
  ...
  "standings.lead":
    "<strong>μ ± σ</strong> — fuerza e incertidumbre. Clasificar / Eliminado — fracción de simulaciones Swiss (~50.000).",
  "standings.sort_label": "Ordenar",
