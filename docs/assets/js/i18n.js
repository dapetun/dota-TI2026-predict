...
const STRINGS = {
  ru: {
    ...
    "mode.title": "Смешивание источников",
    "mode.help": "",
    "mode.current": "Сейчас",
    ...
    "fusion.market_derived":
      "Рынок: Polymarket winner → проекция Swiss-слотов (не букмекерские линии 4-0/вылет). Исследовательский сигнал, не для ставок.",
    "fusion.market_direct":
      "Рынок: прямые Swiss-slot котировки (Polymarket). Исследовательский сигнал, не для ставок.",
    ...
    "how.card5.body":
      "LOO AUC — тест на прошлых TI (ближе к TI 2026). Walk-forward AUC — устойчивость во времени. AUC ~0.5 = монетка; сейчас LOO ≈0.608 (TI12–14), WF ≈0.653.",
    ...
    "how.details_li4":
      "Production: CatBoost-only (без изотоники). Brier/ECE в model_compare.",
    "how.details_li5":
    ...
    "chip.market_derived": "Рынок: Polymarket winner → слоты",
  ...
  en: {
    ...
    "fusion.market_derived":
      "Market: Polymarket winner → projected Swiss slots (not bookmaker 4-0/elim lines). Research only — not for betting.",
    "fusion.market_direct":
    ...
    "chip.market_derived": "Market: Polymarket winner → slots",
